<?php
/**
 * Template Name: Service - Industry Report
 *
 * Service detail page for "Industry Report".
 *
...
$service_image_url = 'https://via.placeholder.com/800x600/1A1C29/ffffff?text=Industry+Report';
...
<main>
  ...
  <section class="relative bg-[#1A1C29] text-white overflow-hidden">
    ...
    <?php else: ?>
      ...
      <svg class="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <defs>
          <pattern id="industry_report-hero-circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#industry_report-hero-circuit)" />
      </svg>
    <?php endif; ?>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7">
          ...
          <nav class="flex items-center gap-2 text-xs font-medium text-white/60 mb-5" aria-label="Breadcrumb">
            ...
            <span class="text-white/30">/</span>
            <span class="text-white">Industry Report</span>
          </nav>
          ...
          <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05] mb-6">
            Industry <span class="italic font-light text-white/85">Report</span>
          </h1>
          <p class="text-base sm:text-lg text-white/85 leading-relaxed mb-4 max-w-2xl font-medium">
            We conduct in-depth research on your industry, competitors, and market trends to uncover actionable insights.
          </p>
          <p class="text-base text-white/70 leading-relaxed max-w-2xl">
            Our reports help you understand opportunities, risks, and positioning, allowing you to make informed decisions and build strategies grounded in real market data.
          </p>
        </div>
        ...
        <div class="lg:col-span-5">
          <div class="relative rounded-2xl overflow-hidden shadow-2xl">
            <img src="<?php echo esc_url($service_image_url); ?>" alt="Industry Report" class="w-full h-auto object-cover aspect-[4/3]" />
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
        ...
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Clear Market Insights</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            We gain clear market insights that reveal opportunities, risks, competitors, and trends, helping you make confident strategic decisions faster today.
          </p>
        </div>
        <!-- Card 02 -->
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Better Strategic Planning</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            You understand your audience, industry dynamics, and positioning gaps, allowing smarter planning, stronger differentiation, and reduced uncertainty across growth initiatives.
          </p>
        </div>
        <!-- Card 03 -->
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Actionable Recommendations</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            You receive actionable data-backed recommendations that guide branding, marketing, and investment priorities with clarity instead of assumptions or guesswork alone.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="relative bg-gradient-to-br from-[#1A1C29] via-[#093D62] to-[#1A1C29] text-white py-20 lg:py-24 overflow-hidden">
    ...
    <svg class="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <pattern id="industry_report-cta-circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          <path d="M10 10 L40 10 L40 40 L70 40 L70 70 M30 90 L30 60 L60 60 L60 30 L90 30" stroke="white" stroke-width="0.8" fill="none" />
          <circle cx="10" cy="10" r="2" fill="white" />
          <circle cx="40" cy="40" r="2" fill="white" />
          <circle cx="70" cy="70" r="2" fill="white" />
      ...
      <rect width="100%" height="100%" fill="url(#industry_report-cta-circuit)" />
    </svg>
