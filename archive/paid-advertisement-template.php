<?php
/**
 * Template Name: Service - Paid Advertisement
 *
 * Service detail page for "Paid Advertisement".
 *
...
$service_image_url = 'https://via.placeholder.com/800x600/1A1C29/ffffff?text=Paid+Ads';
...
<main>
  ...
  <section class="relative bg-[#1A1C29] text-white overflow-hidden">
    ...
    <?php else: ?>
      ...
      <svg class="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <defs>
          <pattern id="paid_advertisement-hero-circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#paid_advertisement-hero-circuit)" />
      </svg>
    <?php endif; ?>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7">
          ...
          <nav class="flex items-center gap-2 text-xs font-medium text-white/60 mb-5" aria-label="Breadcrumb">
            ...
            <span class="text-white/30">/</span>
            <span class="text-white">Paid Advertisement</span>
          </nav>
          ...
          <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05] mb-6">
            Paid <span class="italic font-light text-white/85">Advertisement</span>
          </h1>
          <p class="text-base sm:text-lg text-white/85 leading-relaxed mb-4 max-w-2xl font-medium">
            We create and manage data-driven paid campaigns focused on reaching the right audience, maximizing ROI, and driving measurable growth.
          </p>
          <p class="text-base text-white/70 leading-relaxed max-w-2xl">
            From Google Ads to Meta and beyond, we plan, launch, and continuously optimize campaigns built around your business goals and unit economics.
          </p>
        </div>
        ...
        <div class="lg:col-span-5">
          <div class="relative rounded-2xl overflow-hidden shadow-2xl">
            <img src="<?php echo esc_url($service_image_url); ?>" alt="Paid Advertisement" class="w-full h-auto object-cover aspect-[4/3]" />
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
        ...
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Targeted Audience Reach</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Precise audience targeting and segmentation put your message in front of the people most likely to convert, eliminating wasted spend on irrelevant clicks.
          </p>
        </div>
        <!-- Card 02 -->
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Maximized ROI</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Continuous testing, bid optimization, and creative refinement ensure every dollar works harder, increasing return on ad spend and lowering acquisition cost over time.
          </p>
        </div>
        <!-- Card 03 -->
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Scalable Campaign Performance</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Once we identify winning campaigns, we scale them strategically — growing budgets, expanding audiences, and compounding results without sacrificing efficiency.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="relative bg-gradient-to-br from-[#1A1C29] via-[#093D62] to-[#1A1C29] text-white py-20 lg:py-24 overflow-hidden">
    ...
    <svg class="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <pattern id="paid_advertisement-cta-circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          <path d="M10 10 L40 10 L40 40 L70 40 L70 70 M30 90 L30 60 L60 60 L60 30 L90 30" stroke="white" stroke-width="0.8" fill="none" />
          <circle cx="10" cy="10" r="2" fill="white" />
          <circle cx="40" cy="40" r="2" fill="white" />
          <circle cx="70" cy="70" r="2" fill="white" />
      ...
      <rect width="100%" height="100%" fill="url(#paid_advertisement-cta-circuit)" />
    </svg>
