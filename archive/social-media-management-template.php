 ...
 *
 * Service detail page for "Social Media Management".
 *
...
$service_image_url = 'https://via.placeholder.com/800x600/1A1C29/ffffff?text=Social+Media';
...
<main>
  ...
  <section class="relative bg-[#1A1C29] text-white overflow-hidden">
    ...
    <?php else: ?>
      ...
      <svg class="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <defs>
          <pattern id="social_media_management-hero-circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#social_media_management-hero-circuit)" />
      </svg>
    <?php endif; ?>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7">
          ...
          <nav class="flex items-center gap-2 text-xs font-medium text-white/60 mb-5" aria-label="Breadcrumb">
            ...
            <span class="text-white/30">/</span>
            <span class="text-white">Social Media Management</span>
          </nav>
          ...
          <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05] mb-6">
            Social Media <span class="italic font-light text-white/85">Management</span>
          </h1>
          <p class="text-base sm:text-lg text-white/85 leading-relaxed mb-4 max-w-2xl font-medium">
            We manage and grow your social media presence with strategic content, consistent messaging, and performance-focused execution.
          </p>
          <p class="text-base text-white/70 leading-relaxed max-w-2xl">
            From content planning to community engagement and reporting, we build a social presence that strengthens your brand, engages your audience, and supports long-term business growth.
          </p>
        </div>
        ...
        <div class="lg:col-span-5">
          <div class="relative rounded-2xl overflow-hidden shadow-2xl">
            <img src="<?php echo esc_url($service_image_url); ?>" alt="Social Media Management" class="w-full h-auto object-cover aspect-[4/3]" />
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
        ...
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Consistent Brand Presence</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Your social channels project a unified, on-brand identity across every post, story, and campaign, building recognition and trust with every interaction.
          </p>
        </div>
        <!-- Card 02 -->
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Higher Audience Engagement</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Strategic content tailored to your audience drives meaningful interactions: likes, shares, comments, and saves that signal real interest and amplify your reach.
          </p>
        </div>
        <!-- Card 03 -->
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 3v18h18"/><path d="M7 14l3-3 4 4 5-6"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Measurable Growth</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Performance tracking, content optimization, and clear monthly reporting show you exactly what's working so we can scale the wins and improve what doesn't.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="relative bg-gradient-to-br from-[#1A1C29] via-[#093D62] to-[#1A1C29] text-white py-20 lg:py-24 overflow-hidden">
    ...
    <svg class="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <pattern id="social_media_management-cta-circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          <path d="M10 10 L40 10 L40 40 L70 40 L70 70 M30 90 L30 60 L60 60 L60 30 L90 30" stroke="white" stroke-width="0.8" fill="none" />
          <circle cx="10" cy="10" r="2" fill="white" />
          <circle cx="40" cy="40" r="2" fill="white" />
          <circle cx="70" cy="70" r="2" fill="white" />
      ...
      <rect width="100%" height="100%" fill="url(#social_media_management-cta-circuit)" />
    </svg>
