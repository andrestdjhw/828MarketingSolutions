<?php
/**
 * Template Name: Service - Pitch Deck & Capabilities Development
 *
 * Service detail page for "Pitch Deck &amp; Capabilities Development".
 *
...
$service_image_url = 'https://via.placeholder.com/800x600/1A1C29/ffffff?text=Pitch+Deck';
...
<main>
  ...
  <section class="relative bg-[#1A1C29] text-white overflow-hidden">
    ...
    <?php else: ?>
      ...
      <svg class="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <defs>
          <pattern id="pitch_deck-hero-circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#pitch_deck-hero-circuit)" />
      </svg>
    <?php endif; ?>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7">
          ...
          <nav class="flex items-center gap-2 text-xs font-medium text-white/60 mb-5" aria-label="Breadcrumb">
            ...
            <span class="text-white/30">/</span>
            <span class="text-white">Pitch Deck &amp; Capabilities Development</span>
          </nav>
          ...
          <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05] mb-6">
            Pitch Deck &amp; <span class="italic font-light text-white/85">Capabilities Development</span>
          </h1>
          <p class="text-base sm:text-lg text-white/85 leading-relaxed mb-4 max-w-2xl font-medium">
            We craft clear, persuasive pitch decks and capability presentations that communicate your value and strengthen credibility in every sales conversation.
          </p>
          <p class="text-base text-white/70 leading-relaxed max-w-2xl">
            From narrative structure to visual design, your deck becomes a strategic asset that supports investor meetings, client pitches, and partnership conversations with clarity and confidence.
          </p>
        </div>
        ...
        <div class="lg:col-span-5">
          <div class="relative rounded-2xl overflow-hidden shadow-2xl">
            <img src="<?php echo esc_url($service_image_url); ?>" alt="Pitch Deck &amp; Capabilities Development" class="w-full h-auto object-cover aspect-[4/3]" />
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
        ...
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Compelling Visual Story</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Your deck transforms complex value propositions into a clear visual narrative that holds attention, communicates differentiation, and moves decision-makers toward action.
          </p>
        </div>
        <!-- Card 02 -->
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Stronger Sales Conversations</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Tailored capability presentations equip your team to lead consistent, high-impact conversations that address objections, build trust, and close opportunities faster.
          </p>
        </div>
        <!-- Card 03 -->
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 2L3 7v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-9-5z"/><polyline points="9 12 11 14 15 10"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Increased Credibility</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Professional design and strategic messaging signal competence and trustworthiness, positioning your business as a serious partner worth working with.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="relative bg-gradient-to-br from-[#1A1C29] via-[#093D62] to-[#1A1C29] text-white py-20 lg:py-24 overflow-hidden">
    ...
    <svg class="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <pattern id="pitch_deck-cta-circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          <path d="M10 10 L40 10 L40 40 L70 40 L70 70 M30 90 L30 60 L60 60 L60 30 L90 30" stroke="white" stroke-width="0.8" fill="none" />
          <circle cx="10" cy="10" r="2" fill="white" />
          <circle cx="40" cy="40" r="2" fill="white" />
          <circle cx="70" cy="70" r="2" fill="white" />
      ...
      <rect width="100%" height="100%" fill="url(#pitch_deck-cta-circuit)" />
    </svg>
