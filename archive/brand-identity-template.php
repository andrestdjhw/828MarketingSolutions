<?php
/**
 * Template Name: Service - Brand Identity & Positioning
 *
 * Service detail page for "Brand Identity &amp; Positioning".
 *
...
$service_image_url = 'https://via.placeholder.com/800x600/1A1C29/ffffff?text=Brand+Identity';
...
<main>
  ...
  <section class="relative bg-[#1A1C29] text-white overflow-hidden">
    ...
    <?php else: ?>
      ...
      <svg class="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <defs>
          <pattern id="brand_identity-hero-circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#brand_identity-hero-circuit)" />
      </svg>
    <?php endif; ?>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7">
          ...
          <nav class="flex items-center gap-2 text-xs font-medium text-white/60 mb-5" aria-label="Breadcrumb">
            ...
            <span class="text-white/30">/</span>
            <span class="text-white">Brand Identity &amp; Positioning</span>
          </nav>
          ...
          <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05] mb-6">
            Brand Identity <span class="italic font-light text-white/85">&amp; Positioning</span>
          </h1>
          <p class="text-base sm:text-lg text-white/85 leading-relaxed mb-4 max-w-2xl font-medium">
            We craft your brand's identity, voice, and market positioning to ensure clarity, differentiation, and lasting recognition.
          </p>
          <p class="text-base text-white/70 leading-relaxed max-w-2xl">
            From visual systems to messaging frameworks, we build the foundation your brand needs to resonate with your ideal audience and stand apart in a crowded market.
          </p>
        </div>
        ...
        <div class="lg:col-span-5">
          <div class="relative rounded-2xl overflow-hidden shadow-2xl">
            <img src="<?php echo esc_url($service_image_url); ?>" alt="Brand Identity &amp; Positioning" class="w-full h-auto object-cover aspect-[4/3]" />
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
        ...
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="3"/><path d="M12 2v3M12 19v3M4.22 4.22l2.12 2.12M17.66 17.66l2.12 2.12M2 12h3M19 12h3M4.22 19.78l2.12-2.12M17.66 6.34l2.12-2.12"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Distinct Brand Identity</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Your brand develops a clear, recognizable identity that captures who you are, what you stand for, and why customers should choose you over competitors.
          </p>
        </div>
        <!-- Card 02 -->
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Consistent Messaging</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            Every touchpoint communicates your value with consistency, building trust, recognition, and a unified experience across every channel where your brand shows up.
          </p>
        </div>
        <!-- Card 03 -->
        <div class="group relative bg-white rounded-xl p-7 border border-gray-200 hover:border-[#093D62]/30 hover:shadow-xl transition-all duration-200">
          ...
          <div class="w-12 h-12 rounded-lg bg-[#F8F9FB] text-[#093D62] flex items-center justify-center mb-5 group-hover:bg-[#093D62] group-hover:text-white transition-colors duration-200">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
          </div>
          <h3 class="text-xl font-bold text-[#1A1C29] mb-3 leading-snug">Stronger Market Position</h3>
          <p class="text-sm text-[#1A1C29]/65 leading-relaxed">
            You secure a clear position in your market, making your brand memorable, defensible, and aligned with how your ideal clients perceive and choose providers.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="relative bg-gradient-to-br from-[#1A1C29] via-[#093D62] to-[#1A1C29] text-white py-20 lg:py-24 overflow-hidden">
    ...
    <svg class="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <pattern id="brand_identity-cta-circuit" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          <path d="M10 10 L40 10 L40 40 L70 40 L70 70 M30 90 L30 60 L60 60 L60 30 L90 30" stroke="white" stroke-width="0.8" fill="none" />
          <circle cx="10" cy="10" r="2" fill="white" />
          <circle cx="40" cy="40" r="2" fill="white" />
          <circle cx="70" cy="70" r="2" fill="white" />
      ...
      <rect width="100%" height="100%" fill="url(#brand_identity-cta-circuit)" />
    </svg>
